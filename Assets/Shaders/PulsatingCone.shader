Shader "Custom/PulsatingCone"
{
    Properties
    {
        ...
        _Speed ("Pulse Speed", Range(1, 20)) = 1
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float sine = abs(sin(dist*dist / _RingSpacing * 5. + t));
                float ring = smoothstep(_RingWidth, 0.0, sine);
                float maskOuter = ring * smoothstep(0.95, 0.85, dist);
                float maskInner = maskOuter * smoothstep(0.15, 0.3, dist);
